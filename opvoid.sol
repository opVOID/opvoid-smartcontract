/*
opVOID
how many zeros can be killed by real trust?
opVOID was made by the people for the people as an social experiment 

1BNB Initial LP burned
1Q Supply
50% burned (the blackhole will absorb more tokens with every new transaction)

Feestructure:
every transaction reflects 2% back to holders
3% are allocated to buyback+burn

Telegram: https://t.me/opvoid
...
contract OPVOID is Context, IERC20, Ownable {
    ...
    string private constant _name = "opVOID";
    string private constant _symbol = "OPVOID";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3958795ca5C4d9f7Eb55656Ba664efA032E1357b);
